export const researchArticles = [{
  "id": 1,
  "title": "Monocytes and interstitial macrophages contribute to hypoxic pulmonary hypertension",
...
{
  "id": 2,
  "title": "The 7th International Leh Symposium: Lungs at High Altitude: Molecular Mechanisms and Therapeutics of Hypoxic Lung",
...
{
  "id": 3,
  "title": "Evaluation of the cell death markers for aberrated cell free DNA release in high altitude pulmonary edema",
...
{
  "id": 4,
  "title": "Hypobaric hypoxia modulated structural characteristics of circulating cell free DNA in high altitude pulmonary edema",
...
{
  "id": 5,
  "title": "Respiratory tract infection: An unfamiliar risk factor in high-altitude pulmonary edema",
...
{
  "id": 6,
  "title": "Neutralizing antibody responses to SARS-CoV-2 Omicron variants: Post six months following two-dose & three-dose vaccination of ChAdOx1 nCoV-19 or BBV152",
...
{
  "id": 7,
  "title": "Poly (ADP-ribose) Polymerase-1 modulations in the genesis of thrombosis",
...
{
  "id": 8,
  "title": "Unraveling epigenetic interplay between inflammation, thrombosis, and immune-related disorders through a network meta-analysis",
...
{
  "id": 9,
  "title": "Association of transient mitochondrial functional impairment with acute heat exposure in children from Muzaffarpur region of Bihar, India",
...
export const bookChapters = [
  {
    title: "Genomics of Cardiovascular Diseases",
    authors: "Aastha Mishra and Sandosh Padmanabhan",
    book: "Tandon’s Textbook of Cardiology, 2nd ed.",
    publisher: "Wolters Kluwer",
    year: 2023,
    url: "",
  },
  {
    title: "Harsh environmental stressors of high altitude on pathogens susceptibility",
    authors: "Manzoor Ali, Raushni Choudhary, Stanzen Rabyang, Tashi Thinlas, Aastha Mishra",
    book: "Genomic Surveillance and Pandemic Preparedness",
    publisher: "Elsevier",
    year: 2023,
    url: "https://doi.org/10.1016/B978-0-443-18769-8.00013-1",
  }
];

export const abstracts = [
  {
    title: "The 7th International Leh Symposium...",
    authors: "Rahul Kumar, Aastha Mishra...",
    journal: "Pulm Circ. 2024",
    url: "https://doi.org/10.1002/pul2.70023",
  },
  {
    title: "Cardiovascular Research Convergence 2023...",
    authors: "Nivedita Pathak, Aastha Mishra...",
    journal: "J Pract Cardiovasc Sci 2023",
    url: "https://doi.org/10.4103/jpcs.jpcs_77_23",
  },
  {
    title: "The Genetics And Epigenetics Architecture...",
    authors: "Aastha Mishra and MA Qadar Pasha",
    journal: "Pulm Circ. 2022",
    url: "",
  }
];
