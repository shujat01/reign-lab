  ...
  return (
    <section id="people" className="py-16 md:py-24 bg-neutral-100">
      <div className="container mx-auto px-4 md:px-6">
        <h2 className="text-3xl md:text-4xl font-heading font-bold text-center mb-16">People</h2>
  ...
  <div className="flex flex-col md:flex-row items-center gap-8 bg-white p-6 rounded-lg shadow-md">
    ...
    <div>
      ...
      <div className="flex space-x-4 mt-4">
        ...
        {/* Current Members */}
        <div className="mb-12">
          <h3 className="text-2xl font-heading font-semibold mb-8 text-center md:text-left">Lab Members</h3>
        ...
        <div>
              <h4 className="text-xl font-heading font-semibold mb-4">Lab Trainee</h4>
